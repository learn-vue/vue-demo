<template>
	<div class="adm-adv-index">
		
		<div class="crumbs">
			
			<span class="crumbs-title">广告主管理</span>
...
<style lang="less">
	...
	.adm-adv-index .search-empty{
		text-align:center;
		padding:100px 0;
	}

	.adm-adv-index .search-btn{
		margin-top: 10px;
	}
	...
	.adm-adv-index .crumbs{
		line-height: 50px;
	}

	.adm-adv-index .crumbs-title{
