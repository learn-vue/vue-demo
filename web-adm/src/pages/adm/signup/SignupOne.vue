			...
			signUp:function(){
				...
				this.$http.post('/v1/adm/signup',params).then(function(res){
					...
					this.$route.router.go({
						path:'/adm/signup/next?userId=' + data.result.userId 
					});
...
<style>
	...
	.adm-signup .signup-logo{
		text-align: center;
		color: #0098ce;
		margin-bottom: 20px;
	}

	.adm-signup .signup-step-box{
		text-align: center;
		height: 35px;
	}

	.adm-signup .signup-step{
		display: inline-block;
	}

	.adm-signup .signup-step.active{
		color: #0098ce;
	}

	.adm-signup .step-line{
		margin: 0 20px;
	}

	.adm-signup .signup-content{
		border: 1px solid #c2c3c7;
	}
	
	.adm-signup .signup-tab{
		width: 100%;
		text-align: center;
		display: inline-block; 
		height: 42px;
	...
	.adm-signup .signup-tab.active{
		background: #0098ce;
		color: #fff;
	}

	.adm-signup .signup-steping{
		color: #0098ce;
		background: #fff;
		padding: 10px 20px;
	}
	
	.adm-signup .signup-body{
		background: #fff;
		padding: 30px 85px;
	}
	
	.adm-signup .form-control.verification-code{
		width: 220px;
	}

	.adm-signup .signup-btn{
		margin: 20px 0;
	    width: 150px;
	}

	.adm-signup .btn-cancel{
		margin: 20px 0;
	    width: 150px;
	    margin-left: 25px;
	}
	
	.adm-signup .verification-code-img{
		width: 100px;
		height:34px;
		border:none 0;
		margin-left: 5px;
	...
	.adm-signup .form-control{
		width: 330px;
		display: inline-block;
	}

	.adm-signup .form-group label{
		width: 100px;
		text-align: right;
		padding-right: 15px;
		font-weight: normal;
	...
	.adm-signup .button-group{
		margin-left: 105px;
    	width: 330px;
	}
	/*进度条部分*/
	.adm-signup .signup-title{
		text-align: center;
		padding-left: 0;
		height: 42px;
		margin-bottom: 0;
	...
	.adm-signup .step-three{
		width: 33.333333333%;
		background: #d7dadf;
		color: #fff;
	}

	.adm-signup .step-one .triangle-right{
		border-color: transparent transparent transparent #0098ce;
	}

	.adm-signup .step-three .triangle-right,.adm-signup .step-two .triangle-right{
		border-color: transparent transparent transparent #d7dadf;
	}

	.adm-signup .signup-title .triangle-right {
		border-style: solid;
		border-width: 21px;
		display: inline-block;
		height: 0;
	...
	.adm-signup .signup-title .triangle-right-bg {
