<template>
	<div class="adm-adv-finance">
		
		<div class="crumbs">

			<h4 class="pull-left crumbs-title">广告主财务信息</h4>
...
module.exports = {
	...
	methods:{
		...
		load:function(pageNum){
			...
			var resource = this.$resource('/v1/adm/adv/finance/{pageNum}/{pageSize}');
...
<style lang="less">
	...
	.adm-adv-finance .form-search{
		width: 350px;
	}

	.adm-adv-finance .form-search .btn{
		color: white;
		display: table-cell;
