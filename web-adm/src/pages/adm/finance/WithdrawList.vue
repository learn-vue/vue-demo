<template>
	<div class="adm-withdraw-list">
		
		<div class="crumbs">
		
			<h4 class="pull-left crumbs-title">提现列表</h4>
			
			<a v-link="{path:'/adm/finance/withdraw/create'}" class="btn btn-primary btn-common btn-withdraw">新增提现</a>
...
module.exports = {
	...
	methods:{
		...
		load:function(pageNum){
			...
			var resource = this.$resource('/v1/adm/dev/withdraws/{pageNum}/{pageSize}');
...
<style lang="less">
	...
	.adm-withdraw-list .search-empty{
		text-align:center;
		padding:100px 0;
	...
	.adm-withdraw-list .form-search{
		width: 350px;
	}
	
	.adm-withdraw-list .btn-withdraw{
		margin-top:3px;
		margin-left:10px;
	}

	.adm-withdraw-list .form-search .btn{
		color: white;
		display: table-cell;
