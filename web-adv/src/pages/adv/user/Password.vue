	...
	module.exports = {
		...
		methods:{
			...
			updatePass:function(){
				...
				this.$http.put("/v1/adv/users/current/pass",{
...
<style lang="less">
	...
	.adv-user-pass .crumbs-title{
		margin-bottom: 20px;
		margin-top: 0;
	}
	
	.adv-user-pass .form-title{
		width: 120px;
		text-align: right;
		padding-right: 15px;
		margin-top: 5px;
	...
	.adv-user-pass .form-control{
		width: 30%;
		display: inline-block;
	}

	.adv-user-pass .next-step{
		margin: 0 20px 0 125px; 
	}

	.adv-user-pass .operation-bar{
		margin:30px 0 0 125px;
	}
	
	.adv-user-pass .btn-cancel{
		margin-left:30px;
	}
	
	.adv-user-pass .errors{
		color: red;
		display:inline-block;
		margin-left:10px;
	}
