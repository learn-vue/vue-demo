	...
	<div class="adv-findpsw">
		...
		<div class="findpsw-content clearfix">
			<!-- <div class="findpsw-title">
				<a v-link="{path:'/adv/findpsw'}" class="findpsw-tab active">管理员注册</a>
			</div> -->
	...
	module.exports = {
		data:function(){
			return {
				userName:"",
				verificationCode:'',
				verificationCodeUrl:'/v1/adv/verificationcode?t='+(+(new Date()))
			};
		},
		validators: {
		...
		methods:{
			...
			refreshVerifyCode:function(){
				...
				this.verificationCodeUrl='/v1/adv/verificationcode?t='+(+(new Date()));
			...
			nextStep:function(){
				...
				this.$http.post('/v1/adv/signup',params).then(function(res){
					...
					this.$route.router.go({
						path:'/adv/findpsw/email?userId=' + data.result.userId 
					});
...
<style>
	...
	.adv-findpsw .findpsw-logo{
		text-align: center;
		color: #09c;
		margin: 50px 0;
	}

	.adv-findpsw .findpsw-step-box{
		text-align: center;
		height: 35px;
	}

	.adv-findpsw .findpsw-step{
		display: inline-block;
	}

	.adv-findpsw .findpsw-step.active{
		color: #09c;
	}

	.adv-findpsw .step-line{
		margin: 0 20px;
	}

	.adv-findpsw .findpsw-content{
		border: 1px solid #c2c3c7;
		height: 422px;
		background: #fff;
	}
	
	.adv-findpsw .findpsw-tab{
		width: 100%;
		text-align: center;
		display: inline-block; 
		height: 42px;
	...
	.adv-findpsw .findpsw-tab:hover{
		text-decoration: none;
	}

	.adv-findpsw .findpsw-tab.active{
		background: #09c;
		color: #fff;
	}

	.adv-findpsw .findpsw-steping{
		color: #09c;
		background: #fff;
		padding: 10px 20px;
	}
	
	.adv-findpsw .findpsw-body{
		background: #fff;
		padding: 65px 85px;
	}
	
	.adv-findpsw .form-control.verification-code{
		width: 220px;
	}

	.adv-findpsw .findpsw-btn{
		margin: 20px 0;
	    width: 150px;
	}

	.adv-findpsw .btn-cancel{
		margin: 20px 0;
	    width: 150px;
	    margin-left: 25px;
	}
	
	.adv-findpsw .verification-code-img{
		width: 100px;
		height:34px;
		border:none 0;
		margin-left: 5px;
	...
	.adv-findpsw .form-control{
		width: 330px;
		display: inline-block;
	}

	.adv-findpsw .form-group label{
		width: 100px;
		text-align: right;
		padding-right: 15px;
		font-weight: normal;
	...
	.adv-findpsw .button-group{
		margin-left: 105px;
    	width: 330px;
	}
	/*进度条部分*/
	.adv-findpsw .findpsw-title{
		text-align: center;
		padding-left: 0;
		height: 42px;
		margin-bottom: 0;
	...
	.adv-findpsw .step-one{
		width: 33.33%;
		background: #09c;
		color: #fff;
	}
	
	.adv-findpsw .step-two{
		width: 33.33%;
		background: #cccfd3;
		color: #fff;
	}

	.adv-findpsw .step-three{
		width: 33.33%;
		background: #cccfd3;
		color: #fff;
	}

	.adv-findpsw .step-one .triangle-right{
		border-color: transparent transparent transparent #09c;
	}

	.adv-findpsw .step-three .triangle-right,.adv-findpsw .step-two .triangle-right{
