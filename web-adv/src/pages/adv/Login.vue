	...
	<div class="adv-login">
		...
		<div class="login-content">
			...
			<div class="login-title clearfix">
				<a v-link="{path:'/adv/login'}" class="pull-left login-tab active">广告主账号</a>
			</div>
				...
				<form novalidate>
					...
					<div class="login-body">
						...
						<div class="login-foot">
							<a href="javascript:void(0)" class="pull-left" v-link="{path:'/adv/findpsw/email'}">忘记密码？</a>
							<a href="javascript:void(0)" class="pull-right" v-link="{path:'/adv/signup'}">免费注册</a>
						</div>
...
<style>
	...
	.adv-login .login-tab.active{
		background: #0098ce;
		color: #fff;
	}
	
	.adv-login .login-body{
		background: #fff;
		padding: 30px 40px;
	}

	.adv-login .login-body label{
		font-weight: normal;
	}
	
	.adv-login .verification-code{
		width: 60%;
	}
	...
	.adv-login .login-foot{
		margin-bottom: 20px;
	}

	.adv-login .verification-code-img {
	    border: 0 none;
	    height: 34px;
	    width: 38%;
	}
