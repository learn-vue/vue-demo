	...
	module.exports = {
		...
		methods:{
			...
			nextStep:function(){
				...
				this.$http.put("/v1/dev/findpsw/setNewPass",{
					userId		: this.userId,
					...
					this.$route.router.go({
						path:'/dev/findpsw/success?userId=' + 111
					});
...
<style>
	...
	.dev-findpsw-reset .fz12{
		font-size: 12px;
	}

	.dev-findpsw-reset .margintop15{
		margin-top: 15px;
	}

	.dev-findpsw-reset .findpsw-logo{
		text-align: center;
		color: #09c;
		margin: 50px 0;
	}

	.dev-findpsw-reset .findpsw-step-box{
		text-align: center;
		height: 35px;
	}

	.dev-findpsw-reset .findpsw-step{
		display: inline-block;
	}

	.dev-findpsw-reset .findpsw-step.active{
		color: #09c;
	}

	.dev-findpsw-reset .step-line{
		margin: 0 20px;
	}

	.dev-findpsw-reset .findpsw-content{
		border: 1px solid #c2c3c7;
		margin-bottom: 50px;
	}
	
	.dev-findpsw-reset .findpsw-tab{
		width: 100%;
		text-align: center;
		display: inline-block; 
		height: 42px;
	...
	.dev-findpsw-reset .findpsw-tab:hover{
		text-decoration: none;
	}

	.dev-findpsw-reset .findpsw-tab.active{
		background: #09c;
		color: #fff;
	}

	.dev-findpsw-reset .findpsw-steping{
		color: #09c;
		background: #fff;
		padding: 10px 20px;
	}
	
	.dev-findpsw-reset .findpsw-body{
		background: #fff;
		padding: 65px 85px;
	}

	.dev-findpsw-reset .next-btn{
		margin: 20px 0;
	    width: 150px;
	    padding: 10px 12px;
	}

	.dev-findpsw-reset .btn-cancel{
		margin: 20px 0;
	    width: 150px;
	    margin-left: 25px;
	    padding: 10px 12px;
	...
	.dev-findpsw-reset .errors{
		color: red;
		margin-top: 5px;
		margin-left: 105px;
	}

	.dev-findpsw-reset .font16{
		font-size: 16px;
	}
	
	.dev-findpsw-reset .form-control{
		width: 330px;
		display: inline-block;
	}

	.dev-findpsw-reset .form-group label{
		width: 100px;
		text-align: right;
		padding-right: 15px;
		font-weight: normal;
	...
	.dev-findpsw-reset .button-group{
		margin-left: 105px;
    	width: 330px;
	}
	/*进度条部分*/
	.dev-findpsw-reset .findpsw-title{
		text-align: center;
		padding-left: 0;
		height: 42px;
		margin-bottom: 0;
	...
	.dev-findpsw-reset .step-one{
		width: 33.33%;
		background: #09c;
		color: #fff;
	}
	
	.dev-findpsw-reset .step-two{
		width: 33.33%;
		background: #09c;
		color: #fff;
	}

	.dev-findpsw-reset .step-three{
		width: 33.33%;
		background: #cccfd3;
		color: #fff;
	}

	.dev-findpsw-reset .step-one .triangle-right,.dev-findpsw-reset .step-two .triangle-right{
		border-color: transparent transparent transparent #09c;
	}

	.dev-findpsw-reset .step-three .triangle-right{
