	...
	<div class="dev-login">
		...
		<div class="login-content">
			...
			<div class="login-title clearfix">
				<a v-link="{path:'/dev/login'}" class="pull-left login-tab active">开发者账号</a>
			</div>
			...
			<div class="login-body">
				...
				<validator name="validation" >
					...
					<form novalidate>
						...
						<div class="clearfix">
							<a href="javascript:void(0)" type="submit" class="login-btn" @click="signin" :class="{btn:true,'btn-primary':true,'btn-common':true,disabled:$validation.invalid}">登录</a>
						</div> 
						
						<div class="login-foot">
							<a href="javascript:void(0)" class="pull-left" v-link="{path:'/dev/findpsw/email'}">忘记密码？</a>
							<a href="javascript:void(0)" class="pull-right" v-link="{path:'/dev/signup'}">免费注册</a>
						</div>
...
<style>
	...
	.dev-login .login-tab.active{
		background: #0098ce;
		color: #fff;
	}
	
	.dev-login .login-body{
		background: #fff;
		padding: 30px 40px;
	}

	.dev-login .login-body label{
		font-weight: normal;
	}
	
	.dev-login .verification-code{
		width: 60%;
	}
	...
	.dev-login .login-foot{
		margin-bottom: 20px;
	}
	
	.dev-login .verification-code-img{
		width: 38%;
		height:34px;
		border:none 0;
	}
