<template>
	<div class="dev-overview">
		<div class="today-block">
			...
			<div class="clearfix">
				<div class="col-1-4 pull-left sub-block-first">
					<div class="sub-block">
						<h5>今日请求</h5>
				...
				<div class="col-1-4 pull-left sub-block-last">
					<div class="sub-block">
						<h5>今日收益</h5>
						<div class="spliter"></div>
		...
		<div class="day7-block">
			<h5 class="block-title">7日收益图表</h5>
			<div class="chart-box">
...
<script>
    ...
    module.exports = {
        ...
        ready:function(){
        	...
        	this.$http.get('/v1/dev/stats/adSlotOfToday').then(function(res){
        		this.unmask();
        	...
        	this.mask();
        	this.$http.get('/v1/dev/stats/chargeOf7Day').then(function(res){
        		this.unmask();
