<template>
	...
	<div class="signup-box">
		<div class="dev-signup-steptwo">
		
			<h3 class="signup-logo">ADroi <span class="font16">开发者注册</span></h3>
			...
			<div class="signup-content clearfix">
				...
				<!-- <div class="signup-title">
					<a v-link="{path:'/dev/signup'}" class="signup-tab active">开发者注册</a>
				</div> -->
	...
	module.exports = {
		...
		methods:{
			...
			saveUserInfo:function(){
				...
				this.$http.post('/v1/dev/signup/userInfo',params).then(function(res){
					...
					this.$route.router.go({
						path:'/dev/signup/success?userId=' + data.result.userId 
					});
...
<style>
	...
	.dev-signup-steptwo .require{
		color:red;
	}
	
	.dev-signup-steptwo .signup-logo{
		text-align: center;
		color: #0098ce;
		margin-bottom: 20px;
	}

	.dev-signup-steptwo .signup-step-box{
		text-align: center;
		height: 35px;
	}

	.dev-signup-steptwo .signup-step{
		display: inline-block;
	}

	.dev-signup-steptwo .signup-step.active{
	...
	.dev-signup-steptwo .step-line{
		margin: 0 20px;
	}

	.dev-signup-steptwo .signup-content{
		border: 1px solid #c2c3c7;
		margin-bottom: 50px;
	}
	
	.dev-signup-steptwo .signup-tab{
		width: 100%;
		text-align: center;
		display: inline-block; 
		height: 40px;
	...
	.dev-signup-steptwo .signup-tab.active{
		background: #0098ce;
		color: #fff;
	}

	.dev-signup-steptwo .signup-steping{
		color: #0098ce;
		background: #fff;
		padding: 10px 20px;
	}
	
	.dev-signup-steptwo .signup-body{
		background: #fff;
		padding: 30px 60px;
	}

	.dev-signup-steptwo .signup-btn{
	    margin: 20px 0;
	    width: 150px;
	    margin-left: 25px;
	}

	.dev-signup-steptwo .btn-cancel{
		margin: 20px 0;
	    width: 150px;
	}
	
	.dev-signup-steptwo .errors{
		color: red;
		display:block;
		margin-left:100px;
	}
	
	.dev-signup-steptwo .font16{
		font-size: 16px;
	}
	
	.dev-signup-steptwo .form-control{
		width: 330px;
		display: inline-block;
	}

	.dev-signup-steptwo .form-group label{
		width: 100px;
		text-align: right;
		padding-right: 15px;
		font-weight: normal;
	...
	.dev-signup-steptwo .button-group{
		margin-left: 105px;
    	width: 330px;
	}
	/*进度条部分*/
	.dev-signup-steptwo .signup-title{
		text-align: center;
		padding-left: 0;
		height: 42px;
		margin-bottom: 0;
	...
	.dev-signup-steptwo .step-one{
		width: 33.333333333%;
		background: #0098ce;
		color: #fff;
	}
	
	.dev-signup-steptwo .step-two{
		width: 33.333333333%;
		background: #0098ce;
		color: #fff;
	}

	.dev-signup-steptwo .step-three{
		width: 33.333333333%;
		background: #d7dadf;
		color: #fff;
	}

	.dev-signup-steptwo .step-one .triangle-right,.dev-signup-steptwo .step-two .triangle-right{
		border-color: transparent transparent transparent #0098ce;
	}

	.dev-signup-steptwo .step-three .triangle-right{
		border-color: transparent transparent transparent #d7dadf;
	}

	.dev-signup-steptwo .signup-title .triangle-right {
		border-style: solid;
		border-width: 21px;
		display: inline-block;
		height: 0;
	...
	.dev-signup-steptwo .signup-title .triangle-right-bg {
