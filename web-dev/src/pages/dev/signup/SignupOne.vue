	...
	<div class="dev-signup">
		...
		<div class="signup-content clearfix">
			...
			<!-- <div class="signup-title">
				<a v-link="{path:'/adm/signup'}" class="signup-tab active">开发者注册</a>
			</div> -->
	...
	module.exports = {
		...
		methods:{
			...
			refreshVerifyCode:function(){
				...
				var url=ApiUtil.url("/v1/dev/verificationcode?");
			...
			signUp:function(){
				...
				this.$http.post('/v1/dev/signup',params).then(function(res){
					...
					this.$route.router.go({
						path:'/dev/signup/next?userId=' + data.result.userId 
					});
...
<style>
	...
	.dev-signup .signup-logo{
		text-align: center;
		color: #0098ce;
		margin-bottom: 20px;
	}

	.dev-signup .signup-step-box{
		text-align: center;
		height: 35px;
	}

	.dev-signup .signup-step{
		display: inline-block;
	}

	.dev-signup .signup-step.active{
		color: #0098ce;
	}

	.dev-signup .step-line{
		margin: 0 20px;
	}

	.dev-signup .signup-content{
		border: 1px solid #c2c3c7;
	}
	
	.dev-signup .signup-tab{
		width: 100%;
		text-align: center;
		display: inline-block; 
		height: 42px;
	...
	.dev-signup .signup-tab.active{
		background: #0098ce;
		color: #fff;
	}

	.dev-signup .signup-steping{
		color: #0098ce;
		background: #fff;
		padding: 10px 20px;
	}
	
	.dev-signup .signup-body{
		background: #fff;
		padding: 30px 85px;
	}
	
	.dev-signup .form-control.verification-code{
		width: 220px;
	}

	.dev-signup .signup-btn{
		margin: 20px 0;
	    width: 150px;
	}

	.dev-signup .btn-cancel{
		margin: 20px 0;
	    width: 150px;
	    margin-left: 25px;
	}
	
	.dev-signup .verification-code-img{
		width: 100px;
		height:34px;
		border:none 0;
		margin-left: 5px;
	...
	.dev-signup .form-control{
		width: 330px;
		display: inline-block;
	}

	.dev-signup .form-group label{
		width: 100px;
		text-align: right;
		padding-right: 15px;
		font-weight: normal;
	...
	.dev-signup .button-group{
		margin-left: 105px;
    	width: 330px;
	}
	/*进度条部分*/
	.dev-signup .signup-title{
		text-align: center;
		padding-left: 0;
		height: 42px;
		margin-bottom: 0;
	...
	.dev-signup .step-three{
		width: 33.333333333%;
		background: #d7dadf;
		color: #fff;
	}

	.dev-signup .step-one .triangle-right{
		border-color: transparent transparent transparent #0098ce;
	}

	.dev-signup .step-three .triangle-right,.dev-signup .step-two .triangle-right{
		border-color: transparent transparent transparent #d7dadf;
	}

	.dev-signup .signup-title .triangle-right {
		border-style: solid;
		border-width: 21px;
		display: inline-block;
		height: 0;
	...
	.dev-signup .signup-title .triangle-right-bg {
